...
var App = React.createClass({
  ...
  enhancedPusher: function(){
    //var input = this.refs.myText;
    //var inputValue = input.value; 
    console.log(this.refs);
    //task.participants.push(inputValue);
    //task.states.push("candidate");
  ...
  render: function () {
    return (
      <div>
        <DisplayTable elements={task.participants} colors={colors} states={this.state.states} onClick={this.enhancedPusher} />
